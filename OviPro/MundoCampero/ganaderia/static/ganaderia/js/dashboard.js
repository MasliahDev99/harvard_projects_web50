// Obtener el contexto del canvas para el primer gráfico
var ctx = document.getElementById('myChart').getContext('2d');

// Crear la gráfica de torta (pie chart) para el primer gráfico
var myChart = new Chart(ctx, { // Cambié 'myChart' por 'Chart'
...
// Obtener el contexto del canvas para el segundo gráfico
var ctxOvinos = document.getElementById('myChartOvinos').getContext('2d');

// Crear la gráfica de torta (pie chart) para el segundo gráfico

# Generated by Django 4.2.17 on 2025-01-18 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RP', models.CharField(max_length=50, null=True, unique=True)),
                ('nombre', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('nombre_aux', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('establecimiento_origen', models.CharField(blank=True, max_length=50, null=True)),

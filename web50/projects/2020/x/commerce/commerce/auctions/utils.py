...
def determine_auction_winners():
    #otbenemos todas las subastas que terminaron y no tienen ganador
    ended_auctions = Auctions.objects.filter(end_date__lte=timezone.now(),winner__isnull=True)

    for auction in ended_auctions:
        # obtenemos la oferta mas alta de cada subasta

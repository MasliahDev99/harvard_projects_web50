"""
Django settings for MundoCampero project.
...
SECRET_KEY = 'django-insecure-7$&5h^$8yfau)t8z6wj_4lz!=570dpab8jl@zhvy$=n(zsub8n'
...
WSGI_APPLICATION = 'MundoCampero.wsgi.application'
...
AUTH_USER_MODEL = 'ganaderia.User'
